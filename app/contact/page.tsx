  ...
  return (
    ...
    <div className="customer-support r_container">
            ...
            <div className="get-touch">Get in Touch</div>
             ...
             <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
               <circle cx="22" cy="22" r="22" fill="#E5E6E1"/>
                <path d="M27 30.5H17C14 30.5 12 29 12 25.5V18.5C12 15 14 13.5 17 13.5H27C30 13.5 32 15 32 18.5V25.5C32 29 30 30.5 27 30.5Z" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M27 19L23.87 21.5C22.84 22.32 21.15 22.32 20.12 21.5L17 19" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
             </svg>
        ...
        <div className="question">
          <img src="/question.jpg" alt="question" width={630} height={630} />
          <div className="basic-questions">
          <h5>How can I place a order for books on your website? <GoPlus /></h5>
          <hr />
          <h5>How long does it take to recive my order? <GoPlus /></h5>
          <hr />
          <h5>Do you offer international shipping? <GoPlus /></h5>
          <hr />
          <h5>Are digital books(e-books) available on your platform? <GoPlus /></h5>
          <hr />
          <h5>Do you have a loyalty program for frequent customers? <GoPlus /></h5>
          <hr />
          <h5>How can I contact customer support for assistance? <GoPlus /></h5>
          <hr />
          </div>
...
export default page;
>>>>>>> 8fa414f37ddca747ac5b37493501abadc6655d2c:app/contact/page.tsx
